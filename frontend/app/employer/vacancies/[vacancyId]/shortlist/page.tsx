...
function VacancyShortlistContent() {
      ...
      <EmptyState
        ...
        description={
          isError
            ...
            : "Sign in to view the vacancy shortlist."
        }
        primaryAction={
          <Link
            href="/login"
  ...
  if (!vacancyId) {
    return (
      <EmptyState
        ...
        description="A vacancy is required to open its shortlist."
        primaryAction={
          <Link
            href="/"
            className="inline-flex min-h-control items-center rounded-button border border-border bg-surface px-4 text-sm font-medium text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2"
  ...
  return <VacancyShortlistView vacancyId={vacancyId} enabled />;
}

export default function EmployerVacancyShortlistPage() {
  return (
    <WorkspaceShell role="employer">
      <VacancyShortlistContent />
    </WorkspaceShell>
  );
}
