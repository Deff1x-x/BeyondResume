...
from app.services.employer_hiring_access import (
    ...
    require_shortlist_eligible_candidate,
)
...
def save_candidate_to_shortlist(
    ...
    *,
    ...
    """Idempotently save an eligible candidate for an owned vacancy."""
...
def list_shortlisted_candidates(
    ...
    *,
    ...
    Persisted ineligible rows are soft-filtered and left in the database so a
    restored eligibility state can resurface them without recreating history.
    """
    return list(
        session.execute(
...
def update_candidate_stage(
    ...
    *,
    ...
    """Update hiring stage for an eligible shortlist entry."""
